<script lang="js">
  ...
  // String indices found with indexOf, not taken from the backend: those are
  // UTF-8 byte offsets and a JS string indexes by UTF-16 code unit, which
  // differ for any non-ASCII character.
  ...
  function onSearchInput(event) {
    ...
    searchLoading = true;
    // Debounced: an embedding call plus an FTS5 query per character queues up
    // faster than either can answer once the corpus grows.
